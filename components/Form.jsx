...
export const Form = ({ type, post, setPost, submitting, handleSubmitting }) => {
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <form onSubmit={handleSubmitting} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
        ...
        <label htmlFor="">
          <span className="font-satoshi font-semibold text-base text-gray-700">Tag <span className="font-normal">(#product, #idea, #webdevelopment)</span></span>
